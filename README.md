...
# Generate eval figures (fig3 through fig6)
# taste_pca.png is generated by python -m src.taste (Quick Start step 4)
...
│   └── make_plots.py          # Generates fig3, fig4, fig5, fig6 (taste_pca is from src.taste)
├── data/
...
| `eval/results/taste_pca.png` | PCA of your_take embeddings with taste centroids overlaid (generated by `src.taste`) |
